...
$.i18n.en = {
  ...
  home_page: "Home",
  education_desc:
    "It will take you from the beginner level to develop your first static website<br /> Opportunity to meet with industry-oriented basic software techniques In this course you will find;<strong>HTML, CSS </strong> and as well as <strong>Javascript </strong>languages <strong>terminal</strong> command your computer as a super user using You will learn to give.",
  membership_title:
  ...
  fullstack: "Coding Fundamentals <br/><span>Basic Coding Tutorial</span>",
  duration_time_hours: "Lesson Hours",
  duration_time_week: "Weeks",
  project_count: "projects",
  curriculum: "Curriculum",
  curriculum_desc:
    "Only 8 weeks thanks to our Basic Coding Training program to the level where you can develop your first web software from scratch. you will come.<br /> Our program teaches how software engineers work and the tools they use, the <br />JavaScript programming language fundamentals, basic concepts of HTML and CSS based web world includes.",
...
$.i18n.tr = {
  ...
  home_page: "ana sayfa",
  education_desc:
    "Başlangıç seviyesinden sizi ilk statik web-sitenizi gelistirecek seviyeye taşıyacaktır.<br /> Endüstri odakli temel yazılım teknikleriyle tanısma fırsatı bulacagınız bu kursda; <strong>HTML, CSS </strong> ve <strong>Javascript </strong>dillerinin <br />yanı sıra <strong>terminal</strong> kullanarak bilgisayarınıza bir super kullanıcı olarak komut vermeyi ogreneceksiniz.",
  ...
  fullstack: "Kodlamanın Temelleri <br /><span>Temel Kodlama Eğitimi</span>",
  ...
  curriculum_desc:
    "Temel Kodlama Egitimi programımız sayesinde sadece 8 hafta içerisinde sıfırdan ilk web yazılımınızı geliştirebilecek seviyeye geleceksiniz. <br />Programımız, yazılım mühendislerinin nasıl çalıştığını ve kullandıkları araçların, <br />JavaScript programlama dilini temellerini, HTML ve CSS bazlı web dunyasinin temel konseptlerini içerir.",
  ...
  schedule5_desc: "İşte şimdi kurs boyunca öğrendiğiniz tüm becerileri kullanabileceksiniz. Kendi seçtiğiniz bir fikir üzerinde kurs arkadaşlarınız ile birlikte çalışıp, 2 haftanın sonunda gururla gösterebileceğiniz bir bitirme projesine sahip olacaksınız! 🎓🚀",
...
$.i18n.fr = {
  ...
  home_page: "Accueil",
  education_desc:
    "Il vous emmènera du niveau débutant pour développer votre premier site Web statique montera de niveau.<br />Possibilité de rencontrer des techniques logicielles de base orientées vers l'industrie Dans ce cours, vous trouverez; <strong>HTML, CSS</strong> et ainsi que les langages <strong>Javascript</strong> et <strong>terminal</strong>commandez votre ordinateur en tant que super utilisateur en utilisant Vous apprendrez à donner.",
  membership_title:
  ...
  fullstack:
    "Fondamentaux du codage <br/><span>Tutoriel de codage de base</span>",
  ...
  schedule5_desc: "Vous pourrez maintenant utiliser toutes les compétences que vous avez acquises tout au long du cours. Vous aurez un projet de fin d'études que vous pourrez montrer fièrement au bout de 2 semaines, en travaillant avec vos camarades de cours sur une idée de votre choix ! 🎓🚀",
